...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	 ...
	 * desktop: "assets/images/custom/bg1.png", // 单张图片
	 *
	 * mobile: "https://t.alcy.cc/mp", // 随机图API
	 * mobile: "assets/images/custom/bg1.png", // 单张图片
	 *
	 * 支持配置多张图片（数组），每次刷新页面随机显示一张：
	 * desktop: [
	 *   "assets/images/custom/bg1.png",
	 *   "assets/images/custom/bg2.png",
	 * ],
	 *
	 * mobile:[
	 *   "assets/images/custom/bg1.png",
	...
	src: {
		// 桌面背景图片（支持单张或多张随机）
		// desktop: "assets/images/custom/bg1.png",
		desktop: [
			"assets/images/custom/bg1.avif",
			"assets/images/custom/bg2.avif",
			"assets/images/custom/bg3.avif",
		],
		// 移动背景图片（支持单张或多张随机）
		// mobile: "assets/images/custom/bg1.png",
		mobile: [
			"assets/images/custom/bg1.avif",
			"assets/images/custom/bg2.avif",
			"assets/images/custom/bg3.avif",
